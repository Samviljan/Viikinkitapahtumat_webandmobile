...
const TRANSLATIONS = {
    ...
    admin: {
      ...
      users: {
        ...
        col_role: "Rooli",
        col_types: "Tyypit",
        col_paid: "Lisämaksullinen",
        filter_all: "Kaikki",
        filter_merchant: "Kauppiaat",
        filter_organizer: "Järjestäjät",
    ...
    account: {
      ...
      login_sub: "Kirjautumalla saat käyttöösi profiilin ja tulevaisuudessa lisätoimintoja. Sivuston selailu onnistuu myös ilman tiliä.",
      register_title: "Luo tili",
      register_sub: "Liity yhteisöön ja tallenna profiilisi.",
      email: "Sähköposti",
      password: "Salasana",
      password_min: "Vähintään 8 merkkiä",
      nickname: "Nimimerkki",
      nickname_help: "Tämä näytetään julkisesti.",
      ...
      submit_signin: "Kirjaudu",
      submit_signup: "Luo tili",
      ...
      profile_sub: "Päivitä nimimerkkisi ja kerro mitä lajia harrastat.",
      profile_save: "Tallenna muutokset",
      profile_saved: "Profiili tallennettu",
      account_info: "Tilin tiedot",
      method_password: "Sähköposti / salasana",
    ...
    attending: {
      title: "Tapahtumat joihin osallistut",
      help: "Tähän listaan ilmestyvät kaikki tapahtumat, joihin olet merkinnyt osallistuvasi.",
      events_count: "tapahtumaa",
      empty: "Et ole vielä merkinnyt osallistuvasi yhteenkään tapahtumaan.",
    },
    saved_search: {
      title: "Hakuoletukset",
      help: "Säädä hakuasetukset oletuksena käyttöösi tapahtumalistalla.",
      radius: "Etäisyys",
      categories: "Kategoriat",
      countries: "Maat",
      any: "Kaikki",
      save: "Tallenna oletukset",
      saved: "Oletukset tallennettu",
    },
    stats: {
      title: "Osallistujat (anonyymi)",
      reenactors: "Elävöittäjää",
      fighters: "Taistelijaa",
      total: "Yhteensä",
      privacy_note:
        "Vain rooli- ja kokonaismäärä näytetään. Käyttäjien nimimerkkejä ja sähköposteja EI näytetä yksityisyyssyistä.",
    },
    messaging: {
      feature: "Lisämaksullinen ominaisuus",
      title: "Lähetä viesti osallistujille",
      enabled: "Käytössä",
      send_link: "Lähetä viesti",
      ...
      consent_help:
        "Viesti lähetetään vain niille käyttäjille jotka 1) ovat merkinneet osallistuvansa valitsemaasi tapahtumaan JA 2) ovat antaneet luvan vastaanottaa viestejä rooliasi vastaavasta lähteestä (järjestäjä tai kauppias). Käyttäjien yhteystietoja ei näytetä sinulle.",
      ...
      body: "Viesti",
      body_hint:
        "Pidä viesti tiiviinä — push-viesteissä näkyy vain ensimmäiset ~160 merkkiä.",
      send_btn: "Lähetä",
      sent_toast: "Viesti lähetetty",
      result: "Tulos",
      result_text:
        "Push-viestejä lähetetty: {push}, sähköposteja lähetetty: {email}, ehdot täyttäviä vastaanottajia: {recipients}.",
    },
    about: undefined,
    about: undefined,
    courses: {
    ...
    subs: {
      title: "Uutiskirjeen tilaajat",
      sub: "Lista tilaajista. Voit poistaa vanhentuneita tai virheellisiä osoitteita manuaalisesti.",
      active_count: "{n} aktiivista",
      total_count: "{n} yhteensä",
      search_placeholder: "Etsi sähköpostilla…",
      lang_all: "Kaikki",
      refresh: "Päivitä",
      loading: "Ladataan…",
      empty: "Ei tilaajia tällä haulla.",
      col_email: "Sähköposti",
      col_lang: "Kieli",
      col_status: "Tila",
      col_created: "Tilattu",
      delete_btn: "Poista tilaaja",
      confirm_delete: "Poistetaanko tilaaja {email}? Toimintoa ei voi peruuttaa.",
    },
  },
  en: {
    ...
    admin: {
      ...
      users: {
        ...
        col_role: "Role",
        col_types: "Types",
        col_paid: "Paid feature",
        filter_all: "All",
        filter_merchant: "Merchants",
        filter_organizer: "Organizers",
        filter_admin: "Admins",
    ...
    account: {
      ...
      login_title: "Sign in",
      login_sub: "Signing in unlocks your profile and future features. Browsing remains optional.",
      register_title: "Create account",
      register_sub: "Join the community and save your profile.",
      email: "Email",
      password: "Password",
      password_min: "At least 8 characters",
      nickname: "Nickname",
      nickname_help: "Shown publicly.",
      user_types_label: "I am…",
      user_types_help: "Pick one or many.",
      ...
      profile_sub: "Update your nickname and tell us what you do.",
    ...
    attending: {
      ...
      help: "Every event you marked as attending appears here.",
      events_count: "events",
      empty: "You haven't marked attendance to any event yet.",
    },
    saved_search: {
      title: "Default search filters",
      help: "Pre-fill the events list with these filters whenever you visit it.",
      radius: "Distance",
    ...
    stats: {
      title: "Attendees (anonymized)",
      reenactors: "Reenactors",
      fighters: "Fighters",
      total: "Total",
      privacy_note:
        "Only role and total counts are shown. Nicknames and emails are NEVER exposed for privacy reasons.",
    },
    messaging: {
      feature: "Paid feature",
      title: "Send a message to attendees",
      enabled: "Enabled",
      send_link: "Send message",
      blocked_title: "This feature is not enabled for your account",
      blocked_help:
        "Sending messages to event attendees is a paid feature. Contact support to activate it.",
      consent_help:
        "The message is delivered only to users who 1) have marked attendance for the event you choose AND 2) have given consent to receive messages from your role (organizer or merchant). Their contact details are never shown to you.",
      ...
      body: "Message",
      body_hint:
        "Keep it concise — push notifications only show the first ~160 characters.",
      send_btn: "Send",
      sent_toast: "Message sent",
      result: "Result",
      result_text:
        "Push sent: {push}, emails sent: {email}, eligible recipients: {recipients}.",
    },
    about: undefined,
    courses: {
    ...
    subs: {
      ...
      sub: "List of subscribers. Manually remove stale or invalid addresses.",
      ...
      col_lang: "Lang",
      col_status: "Status",
      col_created: "Subscribed",
      delete_btn: "Delete subscriber",
      confirm_delete: "Delete subscriber {email}? This cannot be undone.",
    },
  },
  sv: {
    ...
    admin: {
      ...
      users: {
        ...
        col_role: "Roll",
        col_types: "Typer",
        col_paid: "Premiumfunktion",
        filter_all: "Alla",
        filter_merchant: "Handelsmän",
        filter_organizer: "Arrangörer",
        filter_admin: "Adminer",
        paid_on_toast: "Premiumfunktion aktiverad",
        paid_off_toast: "Premiumfunktion avaktiverad",
      },
    },
    account: {
      sign_in: "Logga in",
      ...
      login_sub: "Logga in för att få tillgång till profil och kommande funktioner. Du kan även surfa utan konto.",
      register_title: "Skapa konto",
      register_sub: "Gå med i gemenskapen och spara din profil.",
      email: "E-post",
      password: "Lösenord",
      password_min: "Minst 8 tecken",
      nickname: "Smeknamn",
      nickname_help: "Visas offentligt.",
      user_types_label: "Jag är…",
      user_types_help: "Välj ett eller flera.",
      type_reenactor: "Återskapare",
      type_fighter: "Krigare",
      type_merchant: "Handelsman",
      ...
      error_invalid: "Felaktig e-post eller lösenord.",
      error_duplicate: "E-postadressen finns redan.",
      error_generic: "Något gick fel. Försök igen.",
      profile_title: "Min profil",
      profile_sub: "Uppdatera ditt smeknamn och berätta vad du sysslar med.",
      profile_save: "Spara ändringar",
      profile_saved: "Profilen sparad",
      account_info: "Kontouppgifter",
      method_password: "E-post / lösenord",
      method_google: "Google",
    ...
    subs: {
      title: "Nyhetsbrevsprenumeranter",
      sub: "Lista över prenumeranter. Ta bort föråldrade eller ogiltiga adresser manuellt.",
      active_count: "{n} aktiva",
      total_count: "{n} totalt",
      search_placeholder: "Sök på e-post…",
      lang_all: "Alla",
      refresh: "Uppdatera",
      loading: "Laddar…",
      empty: "Inga prenumeranter matchar.",
      col_email: "E-post",
      col_lang: "Språk",
      col_status: "Status",
      col_created: "Prenumererat",
      delete_btn: "Ta bort prenumerant",
      confirm_delete: "Ta bort prenumerant {email}? Detta kan inte ångras.",
    },
  },
  et: {
    "site": {
